package com.zomurb.tgfs.presentation
    ...
    fun triggerCloudRecovery(
        ...
        viewModelScope.launch {
            try {
                ...
                com.zomurb.tgfs.data.local.TgfDatabase.restoreFromBackup(
                    context = context,
        ...
        viewModelScope.launch {
            try {
                ...
                try {
                    ...
                    com.zomurb.tgfs.data.local.DatabaseSyncManager.syncDatabase(getApplication())
